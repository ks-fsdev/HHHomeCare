  ...
  return (
    <div className="flex flex-col gap-1.5 w-full">
      ...
      <div className="relative">
        <input
          type={inputType}
          className="w-full px-5 py-2 rounded-xl border border-border-muted bg-white text-brand-text focus:outline-none focus:ring-2 text-sm focus:ring-secondary focus:border-transparent transition-all placeholder:text-gray-300"
          {...props}
        />
        {isPassword && (
          <button
